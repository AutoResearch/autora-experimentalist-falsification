...
def falsification_pooler(
    ...
    Args:
        ...
        reference_conditions: data_closed_loop that the model was trained on
    ...
    # now that the popper network is trained we can sample new data_closed_loop points
    # to sample data_closed_loop points we need to provide the popper network with an initial
    ...
    # sample data_closed_loop point in proportion to model loss
